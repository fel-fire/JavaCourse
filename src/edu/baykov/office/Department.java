...
public class Department {
    ...
    private void checkDepartamentValueAndAdd(Employee employee) {
        ...
        if ((employee.department != null) && !(employee.department.equals(this))) {
    ...
    public void removeEmployee(Employee employee) {
        ...
        if (employee.equals(employee.department.manager))
    ...
    public String getManagerName() {
        return manager != null? manager.name: "Начальник временно отсутствует";
    }
